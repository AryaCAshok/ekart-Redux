...
import { addToWishlist } from '../redux/slices/wishlistSliceNew';
import { addToCart } from '../redux/slices/cartSlice';

function Home() {
    const data=useFetch('https://dummyjson.com/products') //here function useFecth is aasigned to variable data
     console.log(data);
    const dispatch =useDispatch() // create object for a class
  return (
<>
